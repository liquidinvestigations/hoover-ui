import { makeUnsearchable } from '../src/utils/utils'

it('injects hidden elements but leave <mark> elements intact', () => {
    expect(makeUnsearchable('foo')).toEqual('f<span class="no-find">S</span>o<span class="no-find">S</span>o<span class="no-find">S</span>')
