    ...
    tags: (
        <>
            <Typography variant="body2">
                Tags are made of lowercase ASCII letters, digits, and symbols: <code>_!@#$%^&*()-=+:,./?</code>.
            </Typography>
            <Typography variant="body2">Changes to tags may take a minute to appear in search.</Typography>
            <Typography variant="body2">Tags must be matched exactly when searching.</Typography>
            <Typography variant="body2">
                See more{' '}
                <a
