...
export const search = async (headers, params, type, fields, username) => fetchJson(buildUrl('search'), {
    headers,
    method: 'POST',
    body: JSON.stringify(buildSearchQuery(params, type, fields, username)),
})
